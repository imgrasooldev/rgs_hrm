<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <a href="#" class="nav-link">
          <div class="profile-image">
            <img
              ...
              src="{{ asset(Auth::guard('admin')->user()->image != null?'assets/admin/images/profile/'.Auth::guard('admin')->user()->image:'assets/admin/images/no_profile.png') }}"
              alt="profile image"
            />
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ Route('admin.download_books') }}">
