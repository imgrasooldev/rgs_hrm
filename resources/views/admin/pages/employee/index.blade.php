                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="profileimg">
                                <img src="{{ asset(config('constants.constant.public_path') . 'assets/images/profimg.png') }}" alt="">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="carercard">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="timeimgresp">
                                                <img src="{{ asset(config('constants.constant.public_path') . 'assets/images/img.png') }}"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="carercard">
                                ...
                                <ul class="deptusers">
                                    <li>
                                        <div class="deptlst">
                                            <div class="depusrimg">
                                                <img src="{{ asset(config('constants.constant.public_path') . 'assets/images/user2.png') }}"
                                                    alt="">
                                            </div>
                                            <div>
